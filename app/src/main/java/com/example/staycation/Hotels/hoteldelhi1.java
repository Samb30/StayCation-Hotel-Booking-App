...
public class hoteldelhi1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hdel1);

        button = findViewById(R.id.button);
        hname = findViewById(R.id.textView);
        h1price = findViewById(R.id.price_h7);
        ...
        button.setOnClickListener(view -> {
            ...
            bookingDocumentRef.set(bookingData, SetOptions.merge())
                    .addOnSuccessListener(aVoid-> {
                        ...
                        Intent intent = new Intent(hoteldelhi1.this, Pay1Activity.class);
